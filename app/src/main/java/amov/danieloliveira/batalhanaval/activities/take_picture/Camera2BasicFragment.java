...
public class Camera2BasicFragment extends Fragment
    ...
    public void onViewCreated(@NonNull final View view, Bundle savedInstanceState) {
        ...
        currentCamera = CameraCharacteristics.LENS_FACING_BACK;
        ...
        if (maxCameras <= 1) {
            view.findViewById(R.id.switch_camera).setVisibility(View.INVISIBLE);
        } else {
            view.findViewById(R.id.switch_camera).setOnClickListener(this);
            view.findViewById(R.id.switch_camera).setVisibility(View.VISIBLE);
        }
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getFilesDir().getPath() + "/" + IMAGE_NAME);
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facing != currentCamera) {
                    continue;
                }
    ...
    private void switchCamera() {
        Log.d(TAG, "Old Camera " + currentCamera);
        ...
        Log.d(TAG, "New Camera " + currentCamera);
